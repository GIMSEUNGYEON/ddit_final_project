            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade" id="profile-dclzList" role="tabpanel">
                  ...
                  <form id="searchForm" action="<c:url value='/emp/myInfo/dclzList.do'/>">
                  ...
                  <table class="table table-sm">
    	              ...
    	              <tr>
	                  	<td>근무 형태</td>
	                  	<td id="D"><button class="workType btn btn-outline-primary rounded-pill me-1 mb-1">DAY</button></td>
	                  	<td id="E"><button class="workType btn btn-outline-primary rounded-pill me-1 mb-1">EVENING</button></td>
	                  	<td id="N"><button class="workType btn btn-outline-primary rounded-pill me-1 mb-1">NIGHT</button></td>
	                  	<td id="O"><button class="workType btn btn-outline-primary rounded-pill me-1 mb-1">OFF</button></td>
    	              </tr>
	                  </tbody>
                  </table>
					<table class="table table-sm">
